...
|-------|-----------|-----------|--------------|----------|---------------------|
| 1 (3R, 5P) | 3 | 5 | 100%| 1200|95–98 |
| 2 (5R, 5P) | 5 | 5 |100 % | 0–10|80–85 |
| 3 (3R, 8P) | 3 | 8 | 85–90 %|400–1600 | 95–100|

### คำถามสำหรับการทดลอง
1. เมื่อ Producers มากกว่า Resources จะเกิดอะไรขึ้น?
    // บาง task ต้องรอคิวหรือเกิด timeout เพราะทรัพยากรไม่พอใช้งานพร้อมกันทั้งหมด
2. Load Generator มีผลต่อ Success Rate อย่างไร?
    // ทำให้ระบบมีภาระเพิ่ม, success rate ลดลงชั่วคราว และ wait time สูงขึ้น
3. Counting Semaphore จัดการ Resource Pool อย่างไร?
    // ควบคุมจำนวนการเข้าถึง resource พร้อมกันโดยลด–เพิ่ม count ทุกครั้งที่ take/give เพื่อป้องกันการแย่งทรัพยากรเกินจำนวนที่มีอยู่
