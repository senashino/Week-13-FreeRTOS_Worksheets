...
1. ในทดลองที่ 2 เกิดอะไรขึ้นกับ Queue?
    // Queue ล้นเพราะผู้ผลิตมากเกินไป ทำให้มีสินค้าถูกดรอปเพิ่มขึ้น
2. ในทดลองที่ 3 ระบบทำงานเป็นอย่างไร?
    // ระบบช้าลง Queue เต็มบ่อย ประสิทธิภาพลดลง เห็นการเตือนถี่ขึ้น
3. Load Balancer แจ้งเตือนเมื่อไหร่?
    // แจ้งเตือนเมื่อ Queue มีของค้างเกิน 8 ชิ้น
